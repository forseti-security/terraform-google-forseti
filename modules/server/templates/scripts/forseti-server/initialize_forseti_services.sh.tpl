...
echo "Cloud SQL Instance Connection string: ${project_id}:${cloudsql_region}:${cloudsql_instance_name}"
...
SQL_PROXY_COMMAND+=" -instances=${project_id}:${cloudsql_region}:${cloudsql_instance_name}=tcp:${cloudsql_db_port}"
