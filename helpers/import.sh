...
terraform import "module.$MODULE_LOCAL_NAME.module.client_iam.google_project_iam_member.client_roles[0]" "$PROJECT_ID roles/storage.objectViewer serviceAccount:forseti-client-gcp-$RESOURCE_NAME_SUFFIX@$PROJECT_ID.iam.gserviceaccount.com"
...
terraform import "module.$MODULE_LOCAL_NAME.module.server_iam.google_project_iam_member.server_roles[0]" "$PROJECT_ID roles/storage.objectViewer serviceAccount:forseti-server-gcp-$RESOURCE_NAME_SUFFIX@$PROJECT_ID.iam.gserviceaccount.com"
terraform import "module.$MODULE_LOCAL_NAME.module.server_iam.google_project_iam_member.server_roles[1]" "$PROJECT_ID roles/storage.objectCreator serviceAccount:forseti-server-gcp-$RESOURCE_NAME_SUFFIX@$PROJECT_ID.iam.gserviceaccount.com"
terraform import "module.$MODULE_LOCAL_NAME.module.server_iam.google_project_iam_member.server_roles[2]" "$PROJECT_ID roles/cloudsql.client serviceAccount:forseti-server-gcp-$RESOURCE_NAME_SUFFIX@$PROJECT_ID.iam.gserviceaccount.com"
terraform import "module.$MODULE_LOCAL_NAME.module.server_iam.google_project_iam_member.server_roles[4]" "$PROJECT_ID roles/logging.logWriter serviceAccount:forseti-server-gcp-$RESOURCE_NAME_SUFFIX@$PROJECT_ID.iam.gserviceaccount.com"
