...
terraform import "module.$MODULE_LOCAL_NAME.google_project_service.main[12]" "$PROJECT_ID/serviceusage.googleapis.com"
terraform import "module.$MODULE_LOCAL_NAME.google_project_service.main[13]" "$PROJECT_ID/logging.googleapis.com"
terraform import "module.$MODULE_LOCAL_NAME.google_project_service.main[14]" "$PROJECT_ID/cloudasset.googleapis.com"
terraform import "module.$MODULE_LOCAL_NAME.google_project_service.main[15]" "$PROJECT_ID/storage-api.googleapis.com"
terraform import "module.$MODULE_LOCAL_NAME.google_project_service.main[16]" "$PROJECT_ID/groupssettings.googleapis.com"
