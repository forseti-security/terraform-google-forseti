global:
    ...
    email_recipient: ${forseti_email_recipient}
    email_sender: ${forseti_email_sender}
...
scanner:
    ...
    output_path: gs://${storage_bucket_name}/scanner_violations
...
notifier:
          ...
          notifiers:
            ...
            - name: email_violations
              configuration:
                data_format: csv
                sendgrid_api_key: ${sendgrid_api_key}
                sender: ${forseti_email_sender}
                recipient: ${forseti_email_recipient}
            # Upload violations to GCS.
            - name: gcs_violations
              configuration:
                data_format: csv
                # gcs_path should begin with "gs://"
                gcs_path: gs://${storage_bucket_name}/scanner_violations
    ...
    inventory:
      gcs_summary:
        ...
        data_format: csv
        # gcs_path should begin with "gs://"
        gcs_path: gs://${storage_bucket_name}/inventory_summary
      email_summary:
        enabled: true
        sendgrid_api_key: ${sendgrid_api_key}
        sender: ${forseti_email_sender}
